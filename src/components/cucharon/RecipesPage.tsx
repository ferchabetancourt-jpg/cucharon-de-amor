...
function RecipeListItem({
  ...
  return (
    <li>
      <div
        onClick={onSelect}
        className="group relative rounded-2xl p-5 md:p-6 transition-all duration-300 ease-out cursor-pointer hover:-translate-y-1 hover:shadow-[0_18px_30px_-18px_rgba(47,42,38,0.25)]"
        style={{
          background: "#FFFFFF",
